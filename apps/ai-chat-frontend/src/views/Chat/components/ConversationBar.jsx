...
const ConversationBar = ({
    ...
    return <>
        <div className={"cursor-pointer bg-white text-gray-600 p-2 rounded-xl text-center mb-4 text-sm"}
             onClick={() => {
                 checkoutConversation();
             }}>新建会话
        </div>
        <div className={"overflow-y-scroll scrollbar-none"}>
            ...
            ${item.conversationId === conversationId ? "bg-gray-200 text-gray-500" : "bg-white text-gray-500"} mb-2 text-sm`}
                    onClick={async () => {
                ...
                >
                    ...
                    <div onClick={(e) => {
                        ...
                        <Delete theme={"outline"} fill={"#625958"}/>
                    </div>
                </div>;
            })}
        </div>
